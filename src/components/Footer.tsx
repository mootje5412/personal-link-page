    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://github.com/breachbase" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://discord.gg/breachbase" target="_blank" rel="noopener noreferrer" aria-label="Discord">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} BreachBase. All rights reserved.</p>
