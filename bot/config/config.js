...
module.exports = {
  ...
  stealerTimeoutMs: Number(process.env.STEALER_TIMEOUT_MS || 45000),
  stealerRetries: Number(process.env.STEALER_RETRIES || 1),
  searchMaxWaitMs: Number(process.env.SEARCH_MAX_WAIT_MS || 55000),
  fastSourceTimeoutMs: Number(process.env.FAST_SOURCE_TIMEOUT_MS || 20000),
